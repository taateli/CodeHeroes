Feature: User can add an inproceedings reference to database by filling mandatory fields
    ...
    Given form inproceedings is selected
    When key "MC007" author "Author" title "Design of McDonalds" year "2017" pubisher "publisher " editor "Elina" booktitle "Research" address "osoite" series "3" startingPage "6" endingPage "1" month "4" organization "organisaatio" are inserted
